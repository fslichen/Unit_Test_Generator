...
public class AnotherControllerTest extends BaseTestCase {
    ...
    public void testRestTemplateWithTypesPrimitiveVoid0() throws Exception {
        ...
        String mockedDataToBeUploaded = "{'requestData':{'restTemplate.postForObject':['Bill Clinton','Richard Nixon',null,{'Abraham Lincoln':null}]},'responseData':{'restTemplate.postForObject':null}}";
    ...
    public void testPostAbstractWithTypesAbstractAlphaPojoAlphaPojo0() throws Exception {
        ...
        String mockedDataToBeUploaded = "{'requestData':{'anyService.anyAbstract':[{'name':'Barack Obama'}]},'responseData':{'anyService.anyAbstract':{'name':'Barack Obama'}}}";
