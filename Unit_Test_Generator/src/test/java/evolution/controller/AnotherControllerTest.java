...
public class AnotherControllerTest extends BaseTestCase {
    ...
    public void testPostAbstractWithTypesAbstractAlphaPojoAlphaPojo0() throws Exception {
        ...
        String mockedDataToBeUploaded = "{'requestData':{'anyService.anyAbstract':[{'name':'Donald Trump'}]},'responseData':{'anyService.anyAbstract':{'name':'Bill Clinton'}}}";
    ...
    public void testRestTemplateWithTypesPrimitiveVoid0() throws Exception {
        ...
        String mockedDataToBeUploaded = "{'requestData':{'restTemplate.postForObject':[{},'Bill Clinton',null]},'responseData':{'restTemplate.postForObject':null}}";
